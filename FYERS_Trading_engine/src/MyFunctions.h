...
HoldingsResponse getHoldings(const std::string& auth_header);
...
OrdersResponse getOrders(const std::string& auth_header);
...
bool placeOrder(const std::string& access_token, const PlaceOrder& order, std::string& orderRefNo);
